...
expName = 'PRIYANSHI.AU2220101_motor.sequence'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRIYANSHI\\OneDrive\\Documents\\Priyanshi.AU2220101_MOTOR.SEQUENCE\\PRIYANSHI.AU2220101_motor.sequence_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('C:/Users/PRIYANSHI/Documents/priyanshi_sequence.con.csv'),
